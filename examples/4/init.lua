examples[4] = function () --default example
  ...
  function love.load()
    image1 = love.graphics.newImage( "examples/4/love1.png" )
    image2 = love.graphics.newImage( "examples/4/love2.png" )
    
    shader1 = love.graphics.newShader("examples/4/shader1.fs")
    shader2 = love.graphics.newShader("examples/4/shader2.fs")
